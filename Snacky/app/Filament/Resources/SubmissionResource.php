            ...
            ->actions([
                Tables\Actions\ActionGroup::make([
                    ...
                    Tables\Actions\DeleteAction::make()
                        ->modalDescription(fn (Snack $record) => $record->receipts_exists ? 'This snack attached to the receipt, you cannot delete snacks attached to the receipt' : 'Are you sure you would like to do this?')
                        ->color(fn (Snack $record) => $record->receipts_exists ? 'danger' : 'warning')
                        ->modalHeading(fn (Snack $record) => $record->receipts_exists ? 'Warning! Deleting attached Snack!' : 'Delete Snack')
                        ->before(function (Tables\Actions\DeleteAction $action, Snack $record) {
